...
mtl_pretrainded = '/home/rs/Desktop/DINO_MTL/work_dirs/scheme2' \
                  '/MTL_swin-t-p4-w7_1x1_resisc&dior&potsdam_segquery=10' \
                  '/best_resisc_accuracy_top-1_dior_bbox_mAP_potsdam_mFscore_iter_300000.pth'
model = dict(
    type='MTL',
    backbone=dict(
    ...
    task_weight=dict(cls=1, det=1, seg=1),
    train_cfg=dict(
        cls=dict(
            augments=[
        ...
        seg=dict(),
        task_pretrain=dict(
            rule='dino_mmdet', pretrained=det_pretrainded
            # rule=None, pretrained=mtl_pretrainded
        )),
...
strategy = dict(
    type='round_robin',  # or round_robin
)
